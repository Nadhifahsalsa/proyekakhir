<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        ...
        <div class="left-custom-menu-adp-wrap scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a title="Landing Page" href="/supplier" aria-expanded="false">
                    ...
                    <li>
                        <a title="Landing Page" href="/barangmasuk" aria-expanded="false">
                            <spanclass="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Barang Masuk</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a title="Landing Page" href="/filter" aria-expanded="false">
                            <spanclass="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Filter</span>
                        </a>
                    </li>
                </ul>
            </nav>
